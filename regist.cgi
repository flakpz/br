...
<BODY onLoad="ch(); document.wrt.F_Name.focus()" topmargin="0" marginheight="0">
<CENTER>
<TABLE cellspacing=1 width="800"><TR><TD align="left" bgcolor="#990000">
</b></center>
■ BATTLE ROYALE 전학 수속 ■</TD></TR><TR><TD valign=top><BR>
<center>
『네가 전학/입학 생이지? 내가 담임이야. 학생들한테는,「잠만보」라고 불리고 있고.
<br>아, 쓸데없는 이야길 했군. 어쨌든, 여기에 이름과 성별을 써서 제출해 줄래?<br>
<br><table cellpadding=10 cellspacing=0 border=1>
<tr><td>

<center><font size=4>전학/입학 신청서</font></center><p>
...
<table cellpadding=2 cellspacing=0 border=1 width=310 align=center>
<tr><td width=60>아이디</td><td><INPUT size="8" type="text" name="Id" maxlength="8"></td>
<td width=60>패스워드</td><td><INPUT size="8" type="text" name="Password" maxlength="8"></td></tr>
</table>
...
<table cellpadding=2 cellspacing=0 border=1 width=310 align=center>
<tr><td width=60>대사</td><td colspan=3><INPUT size="32" type="text" name="Message" maxlength="100"></td></tr>
<tr><td width=60>유언</td><td colspan=3><INPUT size="32" type="text" name="Message2" maxlength="100""></td></tr>
<tr><td width=60>자기어필</td><td colspan=3><INPUT size="32" type="text" name="Comment" maxlength="100""></td></tr>
</table>

<table width=310><tr><td>
<font class=9>※대사 : 살해시의 대사, 유언 : 사망시 대사, 자기어필 : 생존자 리스트에 나오는 코멘트.<br>한글 50자까지 가능합니다.</font>
</td></tr></table><br>
...
■ BATTLE ROYALE 전학/입학 수속 종료 ■</TD></TR><TR><TD valign=top><BR><center>
...
이제 막 전학/입학 와서 수학여행이라니, 운도 좋군.<BR>
<BR>
시간에 맞춰서, 늦지 말고 와~!<BR><BR>
<A href="$regist_file?mode=info&Id=$id2&Password=$password2"><B><FONT color="#ff0000" size="+1">수학여행 출발</FONT></B></A><BR>
_HERE_
&FOOTER;
}
...
■ BATTLE ROYALE 전학 수속 종료 ■</TD></TR><TR><TD valign=top><BR>
눈을 뜨자, 교실 같은 곳에 있었다. 분명 수학여행에 갔는데...?<BR>
「맞아, 수학여행 가는 버스 안에서 갑자기 졸음이 와서...」<BR><br>
주위를 둘러보자 다른 학생들도 비척 비척 일어나고 있다.<br> 뭔가 꺼림칙해 자세히 둘러보니 모두의 목에 은색의 목걸이가 채워져 있는 것을 깨달았다.<BR>
깜짝놀라 자신의 목을 만지자, 차가운 금속의 느낌이 전해져 왔다. 모두와 같은, 저 은색 목걸이가 채워져 있었다.<BR>
<BR>
갑자기, 앞에 문에서 한사람의 남자가 들어왔다...<BR>
<BR>
『그럼, 설명하겠습니다. 모두 여기에 오게된것은 다름이 아니라... 오늘, 여러분에게 서로 죽이게 하기 위해서입니다.<BR>
  반항하거나, 그 목걸이를 벗기거나, 탈출하려고 시도한 경우는 그 자리에서 죽는다고 생각하십시오.<BR>
  여러분은, 올해의 "프로젝트" 대상 클래스로 선택되었습니다.<BR>
  규칙은 간단합니다. 서로, 죽이고 최종적으로 살아남으면 되는겁니다. 반칙은 없습니다.<BR><BR>
  아아, 제가 잊었습니다만, 이곳은 섬입니다. 알겠습니까? 여기는 이 섬의 분교입니다.<BR>
  저는 여기에서 계속 있을테니까. 모두 힘내세요, 지켜볼테니까.<BR>
  자, 됐죠. 여길 나가면 어디로 가도 상관없습니다.<BR>
  <br>
  명심할것은 매일 0시에 섬 전체에 방송을 합니다. 하루 한번이요.<BR>
  거기서, 여러분이 가지고 있는 지도에 따라, 몇시부터 이 지역은 위험하다라고 알려줍니다.<BR>
  지도를 잘 보고, 나침반과 지형을 참조해 신속히 그 지역을 나와 주세요.<BR>
  왜냐고요? 그 목걸이가 폭발하기 때문입니다.<BR>
<BR>
  알겠습니까. 그러니까, 건물 안에 있어도 안되요. 굴 속에서 숨어 있어도 전파는 닿습니다.<BR>
  아, 그래그래, 생각난 김에 얘기해야지. 건물 안에 숨는것은 자유입니다.<BR>
<BR>
  아, 그리고 또 하나. 시간제한이 있습니다. 알겠습니까, 시간제한입니다.<BR>
<BR>
  프로그램은 점점 사람이 죽어야 진행되고 3일 동안 죽은 사람이 아무도 없다면 그것으로 끝입니다.<br>
  또 두명 이상 남아도 컴퓨터가 작동해서 남아있는 사람 전원의 목걸이가 폭발합니다. 우승자는 없습니다.<BR>
<BR>
