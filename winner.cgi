...
print "</b></center>\n" ;
print "■ BATTLE ROYALE 역대 생존자 리스트 ■</TD></TR><TR><TD valign=top><BR><center>\n";
...
#스테이터스 테이블
print <<"_HERE_";
<table border=1 cellpadding=1 bordercolor=gray bordercolordark=gray bordercolorlight=black cellspacing=0 width=400>
    <tr>
